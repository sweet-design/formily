export type InputSelectModel = {
    ...
    componentProperties: {
        ...
        lazyLoad: { key: string | undefined; args: string; callback: string };
...
const InputSelectModel: InputSelectModel = {
    /**
    ...
    componentProperties: {
         ...
         * @description 懒加载回调，一般用在大数据量时，且需要使用简单数据结构，值为API接口中心的选项唯一键
...
export default InputSelectModel;
