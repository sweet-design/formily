export type DateRangePickerModel = {
  ...
  componentProperties: {
    ...
    startPlaceholderLangKey: string;
...
const DateRangePickerModel: DateRangePickerModel = {
  ...
  componentProperties: {
    /**
     * @name 选择器类型
     * @description 选择器类型，依次为 time--date--month--year
     * @param {('time', 'date', 'month', 'year')} picker
     * @default 'date'
     */
    picker: 'date',
    /**
    ...
    /**
     * @name 小时间隔
     * @description 显示时间选择时，时间选择小时支持的步长
     * @type {number}
     * @default 1
     */
    hourStep: 1,
    /**
     * @name 分钟间隔
     * @description 显示时间选择时，时间选择分钟支持的步长
     * @type {number}
     * @default 1
     */
    minuteStep: 1,
    /**
     * @name 秒间隔
     * @description 显示时间选择时，时间选择秒支持的步长
     * @type {number}
     * @default 1
     */
    secondStep: 1,
